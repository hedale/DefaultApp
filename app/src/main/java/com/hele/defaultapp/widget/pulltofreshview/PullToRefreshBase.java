...
import com.hele.defaultapp.listener.IPullToRefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private IOnScrollListener iOnScrollListener;
	...
	public void setIOnScrollListener(IOnScrollListener iOnScrollListener) {
		this.iOnScrollListener = iOnScrollListener;
	}

	protected final void setHeaderScroll(int value) {
		if (iOnScrollListener != null) {
			iOnScrollListener.onScroll(value);
		}
		if (DEBUG) {
