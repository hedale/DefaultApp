package com.hele.defaultapp.reporterror;
import java.io.File;
...
public class CustomCrashHandler implements UncaughtExceptionHandler {
	...
	private String savaInfoToSD(Context context, Throwable ex){
		...
		if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
			dir = new File(SDCARD_ROOT + File.separator + DefaultApplicaition.applicationContext.getPackageName() + File.separator + "crash" + File.separator);
			if(!dir.exists()){
				dir.mkdirs();
			}
